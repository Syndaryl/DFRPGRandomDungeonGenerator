...
function monster_room(dungeonOBJ, roomIDX, threat_table) {
    ...
    if (has_monster) {
        ...
        var largest_SM = Math.max.apply(Math, SizeArea.filter(function (x) { return x.Area <= room_area })); // largest SM that wants to live in this room
        ...
        console.log(
            "This is Room "+ roomIDX + "; it is " + room['width'] + " x " + room['height'] + " feet. The largest SM that wants to live here is "+ largest_SM +"\n" +
