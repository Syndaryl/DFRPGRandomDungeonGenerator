...
function monster_room(dungeonOBJ, roomIDX, threat_table, clear = true) {
    console.log("========================================================");
    console.log("monster_room (" + "roomIDX: " + roomIDX + ", threat_table: " + threat_table + ", clear: " + clear + ")");
    ...
    console.log("final chosen monsters for room " + roomIDX + ": " + JSON.stringify(dungeonOBJ.room[roomIDX].monsters));
