...
var service = {
    "gurpsdf": 'http://df-treasure-generator.herokuapp.com/v1/generate/',
    "dfrpg": 'http://syndaryl.hopto.org:5050/api/selected'
};
remote_reaction();
...
function cash_value(target) {
    ...
    var curList = Object.keys(cur).sort(function (a, b) {
...
function clean_number(fpn, sig_figures) {
    ...
    if (wiggle > sig_figures) { wiggle = (wiggle - sig_figures) * 10 }
    else { wiggle = 1; }
