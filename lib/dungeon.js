 ...
 * @param {HTMLDivElement} dungeon_debug
 */
function debug_dump_room_centers(dungeonOBJ, dungeon_debug) {
    var data = [], i =0;
    for (i = 0; i < dungeonOBJ.room.length; i++) {
        if (dungeonOBJ.room[i] != null && dungeonOBJ.room[i] != undefined) {
            var room = {
                ...
                'north': dungeonOBJ.room[i].north,
                'east': dungeonOBJ.room[i].east,
                'south': dungeonOBJ.room[i].south,
                'west': dungeonOBJ.room[i].west,
                'center': {
                    h: (dungeonOBJ.room[i].east + dungeonOBJ.room[i].west) / 2,
                    v: (dungeonOBJ.room[i].north + dungeonOBJ.room[i].south) / 2
                }
            };
            data.push(room);
        }
    ...
    html_debug_dump(dungeon_debug, data);
}
