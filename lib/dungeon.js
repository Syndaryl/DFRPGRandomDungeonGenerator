...
function flavor_text_room(room) {
    ...
    //console.log("descriptions:", JSON.stringify(room.description));
    for (i = 0; i < room.description.length; i++) {
        //room.description[i] = "${ DEBUG } " + room.description[i];
        //console.log("flavor_text " + room.description[i] + " being expanded to ...");
        room.description[i] = expand_tokens(room.description[i], new_trace(), decoration_data);
        //console.log("     " + room.description[i]);
    }
    //console.log("expanded descriptions:", JSON.stringify(room.description));
