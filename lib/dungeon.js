...
function init_form() {
    ...
    function set_defaults() {
        ...
        if (default_query["seed"] && default_query["seed"] != "")
            ...
            new_name();
        if (default_query.resolution)
            $("resolution").setValue(default_query.resolution);
        ...
        function set_default(element_id) {
            if (!(element_id in default_query)) {
                alert(element_id + " is not found in the default query string. Odd.");
                return;
            }
            if ($(element_id) === null) {
            ...
            var default_value = default_query[element_id];
...
function update_self_link() {
    ...
    var options = new dungeon_configuration();
    ...
    options.biomes_fields = arr || ['ANY'];
    options.resolution = $("resolution").getValue() || 25;

    Global_Dungeon = Global_Dungeon.update(options);
...
function save_dungeon_configuration(set_item_key) {
    ...
    dungeon_options_to_save["resolution"] = $("resolution").getValue();
