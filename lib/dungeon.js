...
function html_room_monsters(element, room) {
    if (room['monsters'].length > 0) {
        ...
        for (var i = 0; i < room['monsters'].length; i++) {
            var source = "";
            var options = {};
            if (room['monsters'][i].monster.Source1 != "") source += linkifyStr(room['monsters'][i].monster.Source1, options);
            if (room['monsters'][i].monster.Source1 != "" && room['monsters'][i].monster.Page1 != "") source += " p" + room['monsters'][i].monster.Page1;
            if (room['monsters'][i].monster.Source1 != "" && room['monsters'][i].monster.Source2 != "") source += ", ";
            if (room['monsters'][i].monster.Source2 != "") source += linkifyStr(room['monsters'][i].monster.Source2, options);
            if (room['monsters'][i].monster.Source2 != "" && room['monsters'][i].monster.Page2 != "") source += " p" + room['monsters'][i].monster.Page2;
...
function fill_image(dungeonOBJ, map_details, dungeon_image) {
    ...
    if (palette.fill_hatching === "hatch") {
        ...
        // background_image(dungeon_image, 0, 0, d, e, palette.fill);
    } else {
...
function background_image(dungeon_image, width, height, fill_image) {
