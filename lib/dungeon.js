...
/**
 * 
 * @param {dungeon_configuration} dungeon_opts
 */
...
function travel_distance_dungeon(dungeonOBJ) {
    ...
    {
        console.log("Static distance!");
        travelDistance = dungeon_options['travel_distance'][dungeonOBJ.travel_distance].Type;
        console.log("Static distance set to " + JSON.stringify(travelDistance));
    }
    console.log("travel distance is " + JSON.stringify(travelDistance));
