...
function main_hallways(dungeonOBJ) {
    var midX = Math.round(dungeonOBJ.height / 2);
    var midY = Math.round(dungeonOBJ.width / 2);

    large_tunnel(dungeonOBJ, 3,    1, midY, dungeonOBJ.width - 1, midY);
    large_tunnel(dungeonOBJ, 3,    midX, 1, midX, dungeonOBJ.height - 1);
}
...
function tunnel(dungeonOBJ, i, j, in_dir) {
    ...
    valid_dirs.each(function(each_dir) {
