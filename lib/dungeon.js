...
function init_form() {
    ...
    $('#dungeon_name').bind("change", name_reaction);
    $('#new_name').bind("click", new_name);
    $('#cer').bind("change", new_dungeon);
    $('#generosity').bind("change", new_dungeon);
    $('#travel_distance').bind("change", new_dungeon);
    $('#challenge').bind("change", new_dungeon);
    $('#Resolution').bind("change", resolution_change);
    $('#remote_treasure').bind("change", new_dungeon);
...
document.bind("dom:loaded", init_form);
